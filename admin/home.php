                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            <b><small style="color:white; font-weidth:bold;"><b style="color:#a09e9e; font-size:28px;">Booking</b> Status</small></b>
                        </h1>
                    </div>
                </div>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 New Bookings  <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                                ...
                                <table class=" table">
									...
									{	
										...
										if($co=="Not Confirm")
										{
											echo"<tr>
												<th>".$trow['id']."</th>
                                                <th>".$trow['package_name']."</th>
                                                <th>".$trow['categroy']."</th>
                                                <th>".$trow['price']."</th>
                                                 <th>".$trow['userid']."</th>
												<th>".$trow['Title']." ".$trow['FName']." ".$trow['LName']."</th>
												<th>".$trow['age']."</th>
												<th>".$trow['Email']."</th>
												<th>".$trow['Phone']."</th>
...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<option value=$data[25]>$data[25]</option>";
...
?>
    ...
    </option></select><input type="submit" name="det" value="Delete Bookings" id="d1"></form></td></th>
...
{
	$cn=mysqli_connect("localhost","root","","tourismtrades");
	$s="delete from bookings  where Booking_id='" . $_POST["dd"] . "'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
?> </div>
                                        ...
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Booked Packages  <span class="badge"><?php echo $r ; ?></span>
											</button>
