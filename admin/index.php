...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom">  <h3><a href="../index.php">TOURISM TRADES</a></h3></div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT id FROM admin WHERE usname = '$myusername' and pass = '$mypassword'";
