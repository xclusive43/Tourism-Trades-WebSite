...
@page { margin: 0; }
    ...
    <a href="booking.php"><button class="btn">Back</button></a>
	<body>
	...
	?>
		<header>
			...
			<address style="font-size:14px;font-family:loto; font-weight: bold;" >
				<p>TOURISM TRADES,</p>
		...
		<article>
			...
			<address >
				<p style=" font-size:14px;font-family:loto; text-transform:uppercase;"><?php echo $title.$fname." ".$lname ?> <br></p>
                <p style=" font-size:14px;font-family:loto; padding:8px; letter-spacing:1;"><?php echo $email; ?><br></p>
                <p style="font-size:14px; font-family:loto; padding:8px;">Contact No.: <?php echo $phone; ?></p>
			</address>
			<table class="meta">
				<tr>
